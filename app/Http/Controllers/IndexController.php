...
class IndexController extends Controller
{
    ...
    public function questionCategory(Request $request)
    {
        ...
        return $this->ajaxSuccess($categories);
    }

    // api 问答列表
    public function questionList(Request $request)
    {
        $post_data = $request->only(['offset', 'filter', 'categorySlug']);
        extract($post_data);
        ...
        $questions = call_user_func([$question, $filter], $currentCategoryId, $offset);
        return $this->ajaxSuccess($questions->toArray()['data']);
    }
